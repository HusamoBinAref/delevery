...
import 'package:efood_multivendor/view/screens/auth/sign_up_screen1.dart';
...
class RouteHelper {
  ...
  static const String address = '/address';
   static const String order_ = '/order_';
  ...
  static const String order__Route = '$order_';//OrderScreen
  ...
  static String getMapRoute(AddressModel addressModel, String page,
  {
    ...
    return '$map?address=$_data&page=$page&name=$name';
  }
  static String getAddressRoute() => '$address';//OrderScreen
   static String getOrder_Route() => '$order__Route';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: signUp, page: () => SignUpScreen3()),
    ...
    GetPage(name: map, page: () {
      ...
      return getRoute(MapScreen(fromRestaurant: Get.parameters['page'] == 'restaurant', 
    ...
    GetPage(name: checkout, page: () {
      ...
      return getRoute(_checkoutScreen != null ? _checkoutScreen : !_fromCart ? NotFound() : 
      CheckoutScreen(
 ...
 GetPage(name: order__Route, page: () => getRoute(OrderScreen())),
