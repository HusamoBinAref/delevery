    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: ResponsiveHelper.isMobile(context) ?
         BorderRadius.vertical(top: Radius.circular(0) //Dimensions.RADIUS_EXTRA_LARGE
         )
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                (product.description != null && product.description.isNotEmpty) ? Column(
                  ...
                  children: [
                    Text('الوصف:'.tr, style: robotoMedium), //description
                ...
                // Quantity
                Row(children: [
                  Text('الكمية'.tr, style: robotoMedium), //quantity
                ...
                product.addOns.length > 0 ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('الإضافات'.tr, style: robotoMedium), //addons
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  GridView.builder(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 4,
                ...
                Row(
                  ...
                  children: [
                  Text('${'الإجمالي:'.tr}', style: robotoMedium), //total_amount
                ...
                (!product.scheduleOrder && !_isAvailable) ? SizedBox() :
                 Row(children: [
                   //زر الخيمة
                   /*
                  ElevatedButton(
                  ...
                  Expanded(child: CustomButton(
                    ...
                    'order_now'.tr : fromCart ? 
                    'تحديث السلة'.tr  //update_in_cart
                    : 'add_to_cart'.tr,
                    onPressed: () {
                      Get.back();
                      if(isCampaign) {
