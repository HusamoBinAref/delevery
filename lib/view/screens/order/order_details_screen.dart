      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        color: Theme.of(context).backgroundColor,
            ...
            //  Divider(height: Dimensions.PADDING_SIZE_LARGE),
              ...
              (_order.orderNote  != null && _order.orderNote.isNotEmpty) ? 
        ...
        color: Theme.of(context).backgroundColor,
                ...
                child: Text('restaurant_details'.tr, style: robotoRegular)),
            ...
            child: SizedBox(
              ...
              child: Row(children: [
                ...
                || _order.orderStatus == 'processing' || _order.orderStatus == 'handover'|| _order.orderStatus == 'picked_up') ? Expanded(
                  child: CustomButton(
                    buttonText: 'تتبع الطلب'.tr, //track_order
                ...
                _order.orderStatus == 'pending' ? Expanded(child: Padding(
                  padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                  child: TextButton(
                    style: TextButton.styleFrom(minimumSize: Size(1, 50), 
                    ...
                    onPressed: () {
                      Get.dialog(ConfirmationDialog(
                        icon: Images.warning, description: 'هل انت متأكد من الغاء الطلب؟'.tr,  //are_you_sure_to_cancel
