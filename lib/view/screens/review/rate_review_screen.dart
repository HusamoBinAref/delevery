...
class _RateReviewScreenState extends State<RateReviewScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'rate_review'.tr),  //rate_review
      ...
      body: Column(children: [
        Center(
          child: Container(
            ...
            child: TabBar(
              ...
              [
                Tab(text: widget.orderDetailsList.length > 1 ? 'الاصناف'.tr : 'الاصناف'.tr), //item
                Tab(text: 'delivery_man'.tr),
              ] : [
                Tab(text: widget.orderDetailsList.length > 1 ? 'الاصناف'.tr : 'الاصناف'.tr),
              ],
            ),
          ),
        ),
        ...
        Expanded(child: TabBarView(
          ...
          children: widget.deliveryMan != null ? [
            ...
            DeliveryManReviewWidget(deliveryMan: 
            widget.deliveryMan, orderID: widget.orderDetailsList[0].orderId.toString()),
          ] : [
            ProductReviewWidget(orderDetailsList: widget.orderDetailsList),
          ],
        )),
