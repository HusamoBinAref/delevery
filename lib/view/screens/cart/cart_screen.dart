...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'السلة'.tr,  //my_cart
      ...
      body: GetBuilder<CartController>(
        builder: (cartController) {
          ...
          cartController.cartList.forEach((cartModel) {
            ...
            _availableList.add(DateConverter.isAvailable(cartModel.product.availableTimeStarts,
            ...
            children: [
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return
                               CartProductWidget(cart: cartController.cartList[index],
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('إجمالي السعر'.tr, style: robotoRegular),//item_price
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('الإجمالي'.tr, style: robotoMedium), //subtotal
                            Text(PriceConverter.convertPrice(_subTotal), style: robotoBold),
                          ]),
              ...
              Container(
                ...
                child: CustomButton(
                  ...
                  buttonText: 'تأكيد الطلب'.tr,//'proceed_to_checkout'.tr
