  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(
          status == 1 ? 'تم ارسال طلبك بنجاح'.tr //you_placed_the_order_successfully
           :
           'حدث خطاء : لم يتم ارسال طلبك'.tr,  // your_order_is_failed_to_place
        ...
        Padding(
          ...
          child: Text(
            status == 1 ? 'تم ارسال طلبك بنجاح'.tr 
            : 'فشل في تقديم طلبك '.tr, //your_order_is_failed_to_place_because
