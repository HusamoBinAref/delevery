            ...
            return orderController.distance != null ? Column(
              children: [
                  ...
                  child: Scrollbar(child: SingleChildScrollView(
                    ...
                    child: Center(child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        // Order type
                        Text('التوصيل'.tr, style: robotoMedium), //delivery_option
                        restController.restaurant.delivery ? DeliveryOptionButton(
                          value: 'delivery', 
                          title: 'home_delivery'.tr,
                           charge: _charge, isFree: restController.restaurant.freeDelivery,
                        ) : SizedBox(),
                        restController.restaurant.takeAway ? 
                        DeliveryOptionButton(
                          value: 'take_away', 
                          title: 'حسب المسافة'.tr,  //'take_away'.tr
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('عنوان التوصيل'.tr,//'deliver_to'.tr
                           style: robotoMedium),
                        ...
                        // Coupon
                         Text('هل تملك قسيمة خصم؟'.tr, style: robotoMedium),
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: 'ادخل رمز القسيمة'.tr, //enter_promo_code
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  if(_couponCode.isNotEmpty && !couponController.isLoading) {
                                    ...
                                    showCustomSnackBar('ادخل رمز القسيمة'.tr);
                                  }
                                },
                                child: Container(
                                  height: 50, width: 100,
                        ...
                        Text('طريقة الدفع'.tr,  //choose_payment_method
                        style: robotoMedium),
                        SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        ...
                        CustomTextField(
                          ...
                          hintText: 'اترك ملاحظة للمطعم(اختياري)'.tr,//'additional_note'
                          maxLines: 3,
                        ...
                        */
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          (_deliveryCharge == 0 || (couponController.coupon != null &&
                           couponController.coupon.couponType == 'free_delivery')) ? Text(
                ...
                Container(
                  ...
                  'تأكيد الطلب'.tr,   //'confirm_order'.tr
                  onPressed: () {
                    ...
                    if(orderController.timeSlots == null || orderController.timeSlots.length == 0) {
                      ...
                      DateTime _date = orderController.selectedDateSlot == 0 ? DateTime.now() : 
                    ...
                    if(_orderAmount < restController.restaurant.minimumOrder) {
                      ...
                      if(restController.restaurant.scheduleOrder) {
                        ...
                        showCustomSnackBar('المطعم مغلق الان'.tr); //restaurant_is_closed_now
                      }
                      ...
                      orderController.placeOrder(PlaceOrderBody(
                        ...
                        paymentMethod: _isCashOnDeliveryActive ? orderController.paymentMethodIndex == 0 ? 
                        'cash_on_delivery'
