...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MenuModel(icon: Images.terms, title: 'طلباتي'.tr, backgroundColor: Color(0xFFF99024), route: RouteHelper.getOrder_Route()),

     
     /* MenuModel(icon: Images.language, title: 'language'.tr,
       backgroundColor: Color(0xFF009A5F), route: RouteHelper.getLanguageRoute('menu')),*/
      MenuModel(icon: Images.about_us, title: 'الدعم الفني'.tr, //help_support
       backgroundColor: Color(0xFF00C7B2), route: RouteHelper.getSupportRoute()),
      MenuModel(icon: Images.policy, title: 'privacy_policy'.tr, backgroundColor: Color(0xFF6165D7),
       route: RouteHelper.getHtmlRoute('privacy-policy')),

      /*MenuModel(icon: Images.about_us, title: 'about_us'.tr, backgroundColor: Color(0xFF6AB5FF),
       route: RouteHelper.getHtmlRoute('about-us')),*/
/*
      MenuModel(icon: Images.terms, title: 'terms_conditions'.tr, 
      backgroundColor: Color(0xFFFFC444), route: RouteHelper.getHtmlRoute('terms-and-condition')),*/
    ...
    return PointerInterceptor(
      child: 
      Scaffold(appBar: appBarPage(context,'اعدادات الحساب'),
      body: 
       Container(
