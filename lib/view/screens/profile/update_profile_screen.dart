          ...
          mainWidget: Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Card(
                  child: MyTextField(
                    hintText: 'الاسم الاول'.tr, //'first_name'.tr
                ...
                Card(
                  child: MyTextField(
                    hintText: 'البريد الالكتروني'.tr, // 'email'.tr
                ...
                Card(
                  child: MyTextField(
                    hintText: 'رقم الهاتف'.tr, // 'phone'.tr
