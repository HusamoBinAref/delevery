          ...
          mainWidget: SingleChildScrollView(physics: BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              _isLoggedIn ? Row(children: [
                ...
                ProfileCard(title: 'اجمالي الطلبات'.tr, data: userController.userInfoModel.orderCount.toString()), //'total_order'
              ]) : SizedBox(),
             ...
             /* ProfileButton(icon: Icons.dark_mode, title: 'dark_mode'.tr, isButtonActive: Get.isDarkMode, onTap: () {
              ...
              _isLoggedIn ? GetBuilder<AuthController>(builder: (authController) {
                return ProfileButton(
                  icon: Icons.notifications, title: 'الاشعارات'.tr, //'notification'.tr
              ...
              _isLoggedIn ? ProfileButton(icon: Icons.lock, title: 'change_password'.tr,
               onTap: () {
                Get.toNamed(RouteHelper.getResetPasswordRoute('', '', 'password-change'));
              }) : SizedBox(),
              SizedBox(height: _isLoggedIn ? Dimensions.PADDING_SIZE_SMALL : 0),

              ProfileButton(icon: Icons.edit, title: 'تعديل الملف الشخصي'.tr, onTap: () {  //'edit_profile'.tr
