...
class _SignUpScreenState extends State<SignUpScreen10> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ? WebMenuBar()
          : appBarPage(context, 'انشاء حساب جديد'),
      body: SafeArea(
          child: Scrollbar(
                ...
                return Column(children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      CustomTextField(
                        hintText: 'الاسم الاول', //'first_name'.tr
                      ...
                      CustomTextField(
                        hintText: 'الاسم الاخير', //'last_name'.tr
                      ...
                      CustomTextField(
                        hintText: 'البريد الالكتروني', //'email'.tr
                      ...
                      CustomTextField(
                        hintText: 'كلمة المرور', //'password'.tr
                      ...
                      CustomTextField(
                        hintText: 'تاكيد كلمة المرور', //'confirm_password'.tr
                  ...
                  !authController.isLoading
                      ? CustomButton(
                          buttonText: 'انشاء حساب جديد', //'sign_up'.tr
                      ...
                      Row(children: [
                          Expanded(
                              child: CustomButton(
                                fontSize: 14,
                            buttonText: 'لدي حساب بالفعل ؟', //'sign_in'.tr
                            transparent: true,
