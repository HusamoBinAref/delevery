...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void initState() {
    ...
    /* Get.find<AuthController>().getUserCountryCode().isNotEmpty ? Get.find<AuthController>().getUserCountryCode()
        ...
        if (widget.exitFromApp) {
          if (_canExit) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text('اضغط مرة اخرى للخروج من البرنامج'.tr,
                  style: TextStyle(
                      color: Colors.white)), //back_press_again_to_exit
                      ...
                      Column(children: [
                        ...
                        Row(children: [
                          CodePickerWidget(
                            ...
                            //  _countryDialCode != null ? _countryDialCode : Get.find<LocalizationController>().locale.countryCode
