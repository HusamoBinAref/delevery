        ...
        body: SafeArea(child: Padding(
          ...
          child: GetBuilder<SearchController>(builder: (searchController) {
            ...
            return Column(children: [
              ...
              Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, 
...
IconButton(
      ...
      onPressed: () => Navigator.pop(context),
                ...
                Expanded(child: SearchField(
                  ...
                  hint: 'ابحث عن مطعم او وجبة ...'.tr, //'search_food_or_restaurant'.tr
...
TextButton(onPressed: (){
  searchController.isSearchMode ? Get.back() : searchController.setSearchMode(true);
