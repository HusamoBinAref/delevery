...
import 'package:efood_multivendor/view/_product/product_shimmer.dart';
import 'package:efood_multivendor/view/_product/product_widget.dart';
  ...
  Widget build(BuildContext context) {
   ...
   /* if(isRestaurant) {
    ...
    return !_isNull ? _length > 0 ? GridView.builder(
      ...
      text: noDataText != null ? noDataText :  'no_food_available'.tr,
    ) : GridView.builder(
      key: UniqueKey(),
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisSpacing: Dimensions.PADDING_SIZE_LARGE,
      ...
      ProductShimmer(isEnabled: _isNull, isRestaurant: false, hasDivider: index != shimmerLength-1);
      },
    );
  }
}
