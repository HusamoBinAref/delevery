...
import 'package:efood_multivendor/view/_myShared/photo_view.dart';
        ...
        return Center(
          child: Container(
            ...
            child:    PhotoViewWidget(
                           ...
                           url:  '${isCampaign ? _baseUrls.campaignImageUrl : _baseUrls.productImageUrl}'
                            '/${product.image}',
                         ),
          ),
        );
                       ...
                       child: HCachedNetworkImage(
                        image:
                            '${isCampaign ? _baseUrls.campaignImageUrl : _baseUrls.productImageUrl}'
                            '/${product.image}',
                        height: _desktop ? 120 : 100,
                        width: _desktop ? 120 : 90,
                        fit: BoxFit.cover,
                    ),
                     ),
                  ),
