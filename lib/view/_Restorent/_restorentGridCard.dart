...
import 'package:efood_multivendor/view/_shareWidget/_button.dart';
...
class RestorentCardGrid extends StatelessWidget {
      ...
      children: <Widget>[
        GestureDetector(
            ...
            child: HCachedNetworkImage(
              image:
                  '${isCampaign ? _baseUrls.campaignImageUrl : _baseUrls.restaurantImageUrl}'
                  '/${restaurant.logo}',
              height: _desktop ? 120 : 90,
              ...
              Expanded(
                child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL), //Dimensions.PADDING_SIZE_SMALL
                      Text(
                        restaurant.address ?? '',
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeExtraSmall,
                          // color: StyleTh.grayTextColor,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ? CTextRestent(
                        title: 'مفتوح',
                        background: HStyle.secondaryColor1,
                      )

                    //SizedBox()
                    : CTextRestent(
                        title: 'مغلق',
                        background: HStyle.secondaryColor,
                        forground:HStyle.secondaryTextColor ,
                      ),
